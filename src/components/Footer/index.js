...
const Footer = () => {
  ...
  return (
	  <FooterDiv>
    <FooterFlex>
	  <img src={window.location.pathname==="/pagina-inicial"? homeRed : homeGrey} alt="Home Icon" onClick={()=>goToHomePage(navigate)}/>
	  <img src={window.location.pathname==="/carrinho"? cartRed : cartGrey} alt="Cart Icon" onClick={()=>goToCartPage(navigate)}/>
		<img src={window.location.pathname==="/perfil"? avatarRed : avatarGrey} alt="Avatar Icon" onClick={()=>goToProfilePage(navigate)}/>
